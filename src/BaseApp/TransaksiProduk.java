...
>>>>>>> 49a97e0045e2a45eda10793666a89f011bea1896
           try {
                ...
                for (int i = 0; i < model.getRowCount(); i++) {
                    ...
                    int id_layanan = 1; // Atur sesuai logikamu
                    items.add(new ProdukItem(kd_brg, jumlah, subtotal, id_sm, id_layanan));
                }
...
>>>>>>> 49a97e0045e2a45eda10793666a89f011bea1896
            ...
            for (ProdukItem item : items) {
                stmt2.setString(1, item.getId_sementara());
                stmt2.setInt(2, idTrans);
                stmt2.setInt(3, item.getId_layanan());
                stmt2.setString(4, item.getKd_produk());
                stmt2.setString(5, item.getJumlah());
                stmt2.setString(6, item.getSubtotal());
                stmt2.executeUpdate();

                stmt3.setString(1, item.getId_sementara());
                stmt3.executeUpdate();
            }
...
>>>>>>> 49a97e0045e2a45eda10793666a89f011bea1896
    ...
    class ProdukItem {
        ...
        private String id_sementara;
        private int id_layanan;

        // Constructor, getter dan setter
        public ProdukItem(String kd_produk, String jumlah, String subtotal, String id_sementara, int id_layanan) {
        ...
        public String getId_sementara() { return id_sementara; }
